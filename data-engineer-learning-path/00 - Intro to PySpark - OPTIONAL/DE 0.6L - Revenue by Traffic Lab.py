...
traffic_df = (df
              ...
              .agg(round(sum("revenue"), 4).alias("total_rev"), 
...
# TODO
top_traffic_df = (traffic_df.sort(col("total_rev").desc())
).limit(3)
...
final_df = (top_traffic_df
            .withColumn("total_rev",col('total_rev').cast('decimal(38,1)'))
...
bonus_df = (top_traffic_df
            .withColumn("total_rev", ceil('total_rev'))
            .withColumn('avg_rev', round('avg_rev', 2))
)
